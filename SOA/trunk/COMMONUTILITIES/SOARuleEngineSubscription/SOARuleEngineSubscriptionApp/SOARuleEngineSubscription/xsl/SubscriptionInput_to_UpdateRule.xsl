...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.6.0(build 111214.0600.1553) AT [SAT SEP 13 20:32:31 IST 2014]. -->
?>
    ...
    <top:RuleengineRulesubscribersCollection>
      <xsl:for-each select="/ns1:UpdateRequest/UpdateSubscriptionCollection">
        <top:RuleengineRulesubscribers>
          ...
          <xsl:if test="SubscribeFrequency/ScheduleFrequency">
            <top:rrsFrequency>
              <xsl:value-of select="SubscribeFrequency/ScheduleFrequency"/>
            </top:rrsFrequency>
          </xsl:if>
          <xsl:if test="SubscribeFrequency/ScheduleDay">
            <top:rrsScheduleday>
              <xsl:value-of select="SubscribeFrequency/ScheduleDay"/>
            </top:rrsScheduleday>
          </xsl:if>
          <xsl:if test="SubscribeFrequency/ScheduleDate">
            <top:rrsScheduledate>
              <xsl:value-of select="SubscribeFrequency/ScheduleDate"/>
            </top:rrsScheduledate>
          </xsl:if>
          <xsl:if test="SubscribeFrequency/ScheduleMonth">
          ...
          <xsl:if test="NotificationFormat">
            <top:rrsFileformat>
