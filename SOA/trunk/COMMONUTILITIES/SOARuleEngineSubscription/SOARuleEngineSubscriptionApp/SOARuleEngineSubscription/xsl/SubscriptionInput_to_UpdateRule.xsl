...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.6.0(build 111214.0600.1553) AT [FRI SEP 12 21:30:17 IST 2014]. -->
?>
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
    <top:RuleengineRulesubscribersCollection>
      <xsl:for-each select="/ns1:UpdateRequest/SubscriptionCollection">
