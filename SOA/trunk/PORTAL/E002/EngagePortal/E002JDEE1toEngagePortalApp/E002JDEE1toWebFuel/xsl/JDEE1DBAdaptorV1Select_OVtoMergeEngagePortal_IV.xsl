...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.6.0(build 111214.0600.1553) AT [WED MAR 12 12:15:48 IST 2014]. -->
?>
  ...
  <xsl:template match="/">
    <ns2:PrtListPricesCollection>
      <xsl:for-each select="/top:F5542112Collection/top:F5542112">
        <xsl:if test='(normalize-space(top:tlkcoo) != "") and ((normalize-space(top:tluom4) != "") and (((((normalize-space(top:tlpefj) != "") and (normalize-space(top:tllitm) != "")) and (normalize-space(top:tluorg) != "")) and (normalize-space(top:tluprc) != "")) and (normalize-space(top:tlcrcd) != "")))'>
          <ns2:PrtListPrices>
            <ns2:priceType>
            ...
            <ns2:countryCode>
              <xsl:value-of select='dvm:lookupValue("EngagePortalCountryCode.dvm","CountryCodeJDEE1",normalize-space(top:tlkcoo),"CountryCodeEngage","Invalid")'/>
            </ns2:countryCode>
            <ns2:unitQty>
