...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.6.0(build 111214.0600.1553) AT [THU OCT 30 19:24:50 IST 2014]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                exclude-result-prefixes="xsi xsl ns0 top plt inp1 wsdl xsd tns ns1 xp20 bpws bpel bpm ora socket mhdr oraext dvm hwf med ids xdk xref ldap">
    ...
    <ns1:AccountSummaryPartner>
      <xsl:for-each select="$InvokePALSDB2DBAdapter_OV.Cc070Vs1CssparDtaCollection/top:Cc070Vs1CssparDtaCollection/top:Cc070Vs1CssparDta">
        <ns1:AccountSummaryPartnerData>
          ...
          <ns1:PARTNER_TELEPHONE>
            <xsl:value-of select="top:telefonNr"/>
          </ns1:PARTNER_TELEPHONE>
          <ns1:PARTNER_CREDIT_LIMIT>
