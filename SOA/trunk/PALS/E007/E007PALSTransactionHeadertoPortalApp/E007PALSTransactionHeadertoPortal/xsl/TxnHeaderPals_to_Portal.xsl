...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.6.0(build 111214.0600.1553) AT [THU MAY 15 19:36:59 IST 2014]. -->
?>
  ...
  <xsl:template match="/">
    <ns3:PrtCardTransactionHeaderCollection>
      <xsl:for-each select="$InvokeSelectPALSTxnRecordDBAdapterV1_OV.Cc077Vs1CssordDtaCollection/top:Cc077Vs1CssordDtaCollection/top:Cc077Vs1CssordDta">
        <xsl:if test="(string-length(/inp1:invocationMsg/inp1:CountryCode) = 2) and ((normalize-space(top:salgstransId) != '') and (normalize-space(/inp1:invocationMsg/inp1:CountryCode) != ''))">
