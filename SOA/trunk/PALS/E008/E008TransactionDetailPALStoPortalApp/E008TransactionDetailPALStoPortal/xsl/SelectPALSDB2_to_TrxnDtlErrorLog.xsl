...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.6.0(build 111214.0600.1553) AT [FRI MAY 16 17:36:45 IST 2014]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                exclude-result-prefixes="xsi xsl inp1 plt wsdl top ns0 xsd tns ns1 ns2 aia bpws xp20 bpel bpm ora socket mhdr oraext dvm hwf med ids xdk xref ldap">
  ...
  <xsl:template match="/">
    <ns2:EngageSoaTxndtlErrorlogCollection>
      <xsl:for-each select="/top:Cc078Vs1CssolnjDtaCollection/top:Cc078Vs1CssolnjDta">
        <xsl:if test='(normalize-space(top:endretSgn) > 6.0) or ((normalize-space(top:olkvantitetTp) > 3.0) or ((normalize-space(top:lokproduktNv) > 60.0) or ((normalize-space(top:drivstoffJn) > 1.0) or ((normalize-space(top:kvalitet) > 2.0) or ((normalize-space(top:stasvaregrpKd) > 5.0) or ((normalize-space(top:tilordrelinjeLnr) > 5.0) or ((normalize-space(top:prpslKd) > 3.0) or ((normalize-space(top:ordrelinjeLnr) > 5.0) or ((normalize-space(top:prelimId) > 10.0) or ((normalize-space(top:ordreId) > 10.0) or ((((normalize-space(top:endretSgn) = "") or ((normalize-space(top:endretDt) = "") or ((normalize-space(top:salgstransId) = "") or (normalize-space(top:salgstranslnjLnr) = "")))) or (normalize-space(top:salgstransId) > 10.0)) or (normalize-space(top:salgstranslnjLnr) > 5.0))))))))))))'>
