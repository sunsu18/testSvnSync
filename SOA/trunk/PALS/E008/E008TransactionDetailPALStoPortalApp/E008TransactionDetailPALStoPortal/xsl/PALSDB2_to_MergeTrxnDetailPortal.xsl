...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.6.0(build 111214.0600.1553) AT [THU MAY 22 18:24:27 IST 2014]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                exclude-result-prefixes="xsi xsl inp1 plt wsdl top tns ns0 xsd ns1 ns2 aia bpws xp20 bpel bpm ora socket mhdr oraext dvm hwf med ids xdk xref ldap">
  ...
  <xsl:template match="/">
    <ns2:PrtCardTransactionDetailCollection>
      <xsl:for-each select="$Invoke_SelectPALSDB2DatabaseAdapterV1_OV.Cc078Vs1CssolnjDtaCollection/top:Cc078Vs1CssolnjDtaCollection/top:Cc078Vs1CssolnjDta">
        <xsl:if test="(string-length(normalize-space(top:endretSgn)) &lt;= 6.0) and (((string-length(normalize-space(top:salgstransId)) &lt;= 10.0) and ((((normalize-space(top:salgstransId) != '') and (normalize-space(top:salgstranslnjLnr) != '')) and (normalize-space(top:endretDt) != '')) and (normalize-space(top:endretSgn) != ''))) and (string-length(normalize-space(top:salgstranslnjLnr)) &lt;= 5.0))">
