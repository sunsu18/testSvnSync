...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.6.0(build 111214.0600.1553) AT [FRI OCT 17 12:18:15 IST 2014]. -->
?>
...
-->
        <xsl:if test='(string-length(top:partnerId) > 8.0) or ((string-length(top:kontoId) > 10.0) or ((string-length($InvokePALSDB2DBAdapter_PALSDB2DBAdapterSelect_OutputVariable.Cc071Vs1CssktoDtaCollection/top:Cc071Vs1CssktoDtaCollection/top:Cc071Vs1CssktoDta/top:kundeGrp) > 2.0) or ((normalize-space(top:kontoId) = "") or ((normalize-space(top:partnerId) = "") or (normalize-space(top:deltaTs) = "")))))'>
