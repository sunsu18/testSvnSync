...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.6.0(build 111214.0600.1553) AT [FRI OCT 17 12:27:43 IST 2014]. -->
?>
  ...
  <xsl:template match="/">
    <ns2:PrtAccountCollection>
      <xsl:for-each select="$InvokePALSDB2DBAdapter_PALSDB2DBAdapterSelect_OutputVariable.Cc071Vs1CssktoDtaCollection/top:Cc071Vs1CssktoDtaCollection/top:Cc071Vs1CssktoDta">
        <xsl:if test='(string-length(top:partnerId) &lt;= 8.0) and ((string-length(top:kontoId) &lt;= 10.0) and ((string-length($InvokePALSDB2DBAdapter_PALSDB2DBAdapterSelect_OutputVariable.Cc071Vs1CssktoDtaCollection/top:Cc071Vs1CssktoDtaCollection/top:Cc071Vs1CssktoDta/top:kundeGrp) &lt;= 2.0) and ((normalize-space(top:kontoId) != "") and ((normalize-space(top:partnerId) != "") and (normalize-space(top:deltaTs) != "")))))'>
          <ns2:PrtAccount>
            <ns2:countryCode>
