...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.6.0(build 111214.0600.1553) AT [FRI MAY 09 12:55:51 IST 2014]. -->
?>
    ...
    <top:EngagePalsAccDtaErrorlogCollection>
      <xsl:for-each select="/db:SelectInValidDataTempAccountPortalDBAdapterOutputCollection/db:SelectInValidDataTempAccountPortalDBAdapterOutput">
        <top:EngagePalsAccDtaErrorlog>
          ...
          <top:soaErrorCode>
            <xsl:text disable-output-escaping="no">'E004'</xsl:text>
          </top:soaErrorCode>
          <top:soaErrorDesc>
            <xsl:text disable-output-escaping="no">'Binding Error'</xsl:text>
          </top:soaErrorDesc>
          <top:updatedBy>
