...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.6.0(build 111214.0600.1553) AT [FRI MAY 16 16:14:51 IST 2014]. -->
?>
    ...
    <ns1:Card>
      <xsl:for-each select="$InvokePALSDB2DBAdapter_PALSDB2DBAdapterSelect_OutputVariable.Cc073Vs1CssksiDtaCollection/top:Cc073Vs1CssksiDtaCollection/top:Cc073Vs1CssksiDta">
        <ns1:FieldsDetails>
          ...
          <ns1:accountId>
            <xsl:value-of select="oraext:query-database(concat(&quot;SELECT ACCOUNT_ID FROM PRT_CARDGROUP WHERE (COUNTRY_CODE='&quot;,/client:invocationMsg/client:CountryCode,&quot;' AND PARTNER_ID = '&quot;,top:partnerId,&quot;' AND CARDGROUP_MAIN_TYPE = '&quot;,top:fForholdHtp,&quot;' AND CARDGROUP_SUB_TYPE = '&quot;,top:fForholdUtp,&quot;'AND CARDGROUP_SEQ = '&quot;,top:fForholdLnr,&quot;')&quot;),false(),false(),&quot;jdbc:oracle:thin:wcpcustom/wcpcustom@10.24.237.66:1521/wcp001t.statoilfuelretail.com&quot;)"/>
          </ns1:accountId>
