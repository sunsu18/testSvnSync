...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.6.0(build 111214.0600.1553) AT [THU OCT 30 19:20:47 IST 2014]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                xmlns:ns3="http://www.statoilfuelretail.com/integration/E005/MergeCardGroupValidate"
                ...
                exclude-result-prefixes="xsi xsl inp1 plt wsdl xsd tns ns0 top ns1 ns2 xp20 bpws bpel bpm ora socket mhdr oraext dvm hwf med ids xdk xref bpmn ldap">
  ...
  <xsl:template match="/">
    <ns2:PrtCardgroupCollection>
      <xsl:for-each select="$InvokeSelectPALSDB2Adapter_OV.Cc072Vs1CssffoDtaCollection/top:Cc072Vs1CssffoDtaCollection/top:Cc072Vs1CssffoDta">
        <xsl:if test='(normalize-space(top:fForholdLnr) != "") and (((normalize-space(top:fForholdHtp) != "") and (((string-length(normalize-space(top:fForholdTx)) &lt;= 45.0) and (((((((normalize-space(top:kontoId) != "") and (string-length(normalize-space(top:partnerId)) &lt;= 8.0)) and (string-length(normalize-space(/inp1:invocationMsg/inp1:CountryCode)) &lt;= 2.0)) and (string-length(normalize-space(top:fForholdHtp)) &lt;= 3.0)) and (string-length(normalize-space(top:fForholdUtp)) &lt;= 3.0)) and (string-length(normalize-space(top:fForholdLnr)) &lt;= 5.0)) and (string-length(normalize-space(top:kontoId)) &lt;= 10.0))) and (normalize-space(top:partnerId) != ""))) and (normalize-space(top:fForholdUtp) != ""))'>
          <ns2:PrtCardgroup>
            <ns2:countryCode>
            ...
            <ns2:cardgroupDescription>
              <xsl:if test="$InvokeSelectPALSDB2Adapter_OV.Cc072Vs1CssffoDtaCollection/top:Cc072Vs1CssffoDtaCollection/top:Cc072Vs1CssffoDta/top:fForholdTx/@xsi:nil">
                <xsl:attribute name="xsi:nil">
                  <xsl:value-of select="$InvokeSelectPALSDB2Adapter_OV.Cc072Vs1CssffoDtaCollection/top:Cc072Vs1CssffoDtaCollection/top:Cc072Vs1CssffoDta/top:fForholdTx/@xsi:nil"/>
                </xsl:attribute>
              </xsl:if>
