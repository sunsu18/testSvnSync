...
PARTITION BY LIST(COUNTRY_CODE) (
    PARTITION PRT_DRIVER_INFORMATION_SWEDEN VALUES ('SE'),
    PARTITION PRT_DRIVER_INFORMATION_NORWAY VALUES ('NO'),
    PARTITION PRT_DRIVER_INFORMATION_DENMARK VALUES ('DK'),
    PARTITION PRT_DRIVER_INFORMATION_LATVIA VALUES ('LV'),
    PARTITION PRT_DRIVER_INFORMATION_LITHUANIA VALUES ('LT'),
    PARTITION PRT_DRIVER_INFORMATION_ESTONIA VALUES ('EE'),
    PARTITION PRT_DRIVER_INFORMATION_POLAND VALUES ('PL')
)
