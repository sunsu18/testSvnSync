...
public class Constants {
    ...
    //Engage Literals to FIX Sonar "Avoid Duplicate Literals" Check
    ...
    public static final String ACCOUNT_ID_LITERAL = "accountId";
    public static final String CARD_NO_LITERAL = "cardNo";
    public static final String CARDNUMBER_LITERAL = "CardNumber";
    public static final String DRIVER_CARD_EXIST_LITERAL = "DRIVER_CARD_EXIST";
    public static final String TRUCK_CARD_EXIST_LITERAL = "TRUCK_CARD_EXIST";
    public static final String ENGAGE_SELECT_TRANSACTION_MANDATORY_LITERAL = "ENGAGE_SELECT_TRANSACTION_MANDATORY";
    public static final String ADD_LITERAL = "Add";
    public static final String EDIT_LITERAL = "Edit";
    public static final String PROFILE_LITERAL = "profile";
    public static final String CUSTOMER_TYPE_LITERAL = "customerType";
    public static final String INFO_TYPE_LITERAL = "infoType";
    public static final String FROM_DATE_LITERAL = "fromDate";
    public static final String TO_DATE_LITERAL = "toDate";
    public static final String ROLE_LITERAL = "role";
    public static final String COUNTRYCODE_LITERAL = "countryCode";
    public static final String LANG_LITERAL = "lang";
    public static final String ENGAGE_CATEGORY_ADMIN_LITERAL = "ENGAGE_CATEGORY_ADMIN";
    public static final String CARDTYPELIST_LITERAL = "cardTypeList";
    public static final String CARD_GROUP_LITERAL = "CardGroup";
    public static final String DEFAULT_LITERAL = "Default";
    public static final String CARD_LITERAL = "Card";
    public static final String VEHICLE_LITERAL = "Vehicle";
    public static final String COUNTRY_CODE_LITERAL = "country_Code";
    public static final String TRANSACTION_LITERAL = "TRANSACTION";
    public static final String REPORT_PAGE_LITERAL = "report_Page";
    public static final String REPORT_TYPE_LITERAL = "report_Type";
    public static final String ACCOUNT_LITERAL = "account";
    public static final String LISTNAME_LITERAL = "listName";
    public static final String AND_LITERAL = "AND ";
    public static final String CARD2ID_LITERAL = "card2id";
    public static final String INTERNATIONAL_LITERAL = "International";
    public static final String ENG_ALL_LITERAL = "ENG_ALL";
    public static final String XLS_LITERAL = "xls";
    public static final String TOTAL_AMOUNT_LITERAL = "Total Amount";
    public static final String VAT_LITERAL = "Vat";
    public static final String NET_LITERAL = "Net";
    public static final String TRANSACTION_SPECIFIC_ERROR_LITERAL = "TRANSACTION_SPECIFIC_ERROR";
    public static final String TRANSACTION_SPECIFIC_ERROR_SELECTION_LITERAL = "TRANSACTION_SPECIFIC_ERROR_SELECTION";
    public static final String TRANSACTIONS__LITERAL = "Transactions";
    public static final String INVOICES_LITERAL = "INVOICES";
    public static final String PARTNER_LITERAL = "Partner";
    public static final String CSV_LITERAL = "csv";
    public static final String CONTENT_TYPE_LITERAL = "text/plain";
    public static final String LANG_REPORT_LITERAL = "langReport";
    public static final String UNBLOCKED_PLURAL_LITERAL = "UNBLOCKED_PLURAL";
    public static final String TEMPORARY_BLOCKED_LITERAL = "TEMPORARY_BLOCKED";
    public static final String PERMANENT_BLOCKED_LITERAL = "PERMANENT_BLOCKED";
    public static final String EXPIRED_LITERAL = "EXPIRED";
    public static final String CURRENT_DATE_LITERAL = "currentDate";
    public static final String STATUS_LITERAL = "status";
    public static final String DRIVER_NUMBER_LITERAL = "DriverNumber";
    public static final String DRIVER_MODIFIED_BY_LITERAL = "driverModifiedBy";
    public static final String DRIVER_NAME_LITERAL = "DriverName";
    public static final String VEHICLE_NUMBER_LITERAL = "VehicleNumber";
    ...
    public static final String DRIVER_LITERAL = "Driver";
    public static final String VEHICLE_DIRVER_VALUE_LITERAL = "vehicleDriverValue";
    public static final String MODIFIED_BY_LITERAL = "modifiedBy";
    public static final String DATE_FORMAT_LITERAL = "dd.MM.yyyy HH:mm";
    public static final String VEHICLE_MODIFIED_DATE_LITERAL = "vehicleModifiedDate";
    public static final String PARTNER_LANG_LITERAL = "partnerLang";
    public static final String ALERTS_ACCOUNT_QUERY_LITERAL = "alerts_account_Query";
    public static final String ALERTS_CARDGROUP_QUERY_LITERAL = "alerts_cardGroup_Query";
    public static final String ALERTS_CARD_QUERY_LITERAL = "alerts_card_Query";
    public static final String SUBSCRIBE_ALERTS_LITERAL = "subscribeAlerts";
    public static final String DAILY_LITERAL = "DAILY";
    public static final String EMAIL_LITERAL = "EMAIL";
    public static final String EXCEL_LITERAL = "EXCEL";
    public static final String SUBSCRIBE_REQUEST_LITERAL = "subscribeRequest";
    public static final String USER_ID_LITERAL = "UserId";
    public static final String SUBSCR_ID_LITERAL = "SubscrId";
    public static final String RULE_ID_LITERAL = "RuleId";
    public static final String ACTIVE_LITERAL = "ACTIVE";
    public static final String ALL_LITERAL = "ALL";
    public static final String PARTNER_ID_LITERAL = "PartnerId";
    public static final String CARDGROUP_MAIN_LITERAL = "CardgroupMain";
    public static final String CARDGROUP_SUB_LITERAL = "CardgroupSub";
    public static final String CARDGROUP_SEQ_LITERAL = "CardgroupSeq";
    public static final String CADRDKSID_LITERAL = "CardKsid";
    public static final String COMMIT_LITERAL = "Commit";
    public static final String TRUE_LITERAL = "true";
    public static final String FUEL_PER_DAY_LITERAL = "FuelPerDay";
    public static final String FUEL_PER_WEEK_LITERAL = "FuelPerWeek";
    public static final String FUEL_PER_MONTH_LITERAL = "FuelPerMonth";
    public static final String PID_LITERAL = "pId";
    public static final String SUBSCRID_KEY_LITERAL = "SubscrIdkey";
    public static final String RULEID_KEY_LITERAL = "RuleIdkey";
    public static final String PARTNERID_KEY_LITERAL = "PartnerIdkey";
    public static final String ACCOUNTID_KEY_LITERAL = "AccountIdkey";
