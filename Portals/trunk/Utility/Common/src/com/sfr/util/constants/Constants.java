...
public class Constants {
    ...
    public static final String SESSION_SELECT_MARINE_BRANCH_PLANT="SESSION_SELECT_MARINE_BRANCH_PLANT";//HashMap<String,String>. But will contain only one/zero record
