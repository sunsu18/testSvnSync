...
public class OIMUserManagermentImplPortClient
{
  @WebServiceRef
  private static OIMUserManagermentImpl_Service oIMUserManagermentImpl_Service;

    public static void main(String[] args) {
        try {
            oIMUserManagermentImpl_Service = new OIMUserManagermentImpl_Service();
            OIMUserManagermentImpl oIMUserManagermentImpl = oIMUserManagermentImpl_Service.getOIMUserManagermentImplPort();

            Map<String, Object> requestContext = ((BindingProvider) oIMUserManagermentImpl).getRequestContext();
