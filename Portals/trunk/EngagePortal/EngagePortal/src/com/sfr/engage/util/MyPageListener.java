...
public class MyPageListener implements PagePhaseListener {
    ...
    public void beforePhase(PagePhaseEvent pagePhaseEvent) {
        ...
        try {
            if (phase.equals(ADFLifecycle.PREPARE_MODEL_ID)) {
                ...
                if (session != null) {
                    log.info(accessDC.getDisplayRecord() + this.getClass() + ".beforePhase : " +
                             "********************Session is NOT NULL*************************");
                    log.info(accessDC.getDisplayRecord() + this.getClass() + ".beforePhase : " + "################Session ID: " + session.getId());
                } else {
                    log.info(accessDC.getDisplayRecord() + this.getClass() + ".beforePhase : " + "Session is NULL");
            ...
            if (phase == 9) {
                ...
                if (securityContext.isAuthenticated()) {
                    ...
                    if (session.getAttribute(Constants.SESSION_USER_INFO) == null) {
                        log.info(accessDC.getDisplayRecord() + this.getClass() + ".beforePhase : " + "UserInfo in session is null , Fetching the data");
            ...
            if (phase == PhaseId.RESTORE_VIEW.getOrdinal()) {
                ...
                if (!AdfFacesContext.getCurrentInstance().isPostback()) {
                    ...
                    log.info(accessDC.getDisplayRecord() + this.getClass() + ".beforePhase : " + "facesCtx.getViewRoot().getViewId():: " + currentViewId);
                    ...
                    if (currentViewId.contains("login")) {
                        if (securityContext.isAuthenticated()) {
                            log.info(accessDC.getDisplayRecord() + this.getClass() + ".beforePhase : " + "Inside OAM authenticated");
                            ...
                            log.info(accessDC.getDisplayRecord() + this.getClass() + ".beforePhase : " + "User in session =<" +
                    ...
                    if (securityContext.isAuthenticated() && currentViewId.contains("home") && user.getRolelist().contains(Constants.ROLE_WCP_CARD_CSR) &&
                        session.getAttribute("IS_SELECT_ASSOCIATION_DONE") == null) {
                    ...
                    } else if (securityContext.isAuthenticated() && currentViewId.contains("home") &&
                               session.getAttribute("IS_HOME_REDIRECTION_DONE") == null) {
            ...
            if (phase.equals(ADFLifecycle.INIT_CONTEXT_ID)) {
                ...
                if (session.getAttribute(Constants.SESSION_USER_INFO) != null && session.getAttribute("executePartnerObjLogic") == null) {
                    ...
                    for (int i = 0; i < user.getRoleList().size(); i++) {
...

                        {
                            ...
                            int idlist = 0;
                            log.info(accessDC.getDisplayRecord() + this.getClass() + " user.getRoleList().get(i).getIdString().size()" +
                                     user.getRoleList().get(i).getIdString().size());
                            do {
                                partnerobj = new PartnerInfo();

                                int pIdStart = user.getRoleList().get(i).getIdString().get(idlist).indexOf("PP");

                                String pid = user.getRoleList().get(i).getIdString().get(idlist).substring(pIdStart + 2, pIdStart + 10);
                    ...
                    log.info(accessDC.getDisplayRecord() + this.getClass() + " Final Partner list size after going through the entire RoleList " +
                    ...
                    {
                        log.info(accessDC.getDisplayRecord() + this.getClass() + "Session is not null & executePartnerObjLogic value is " +
                        ...
                        if (session.getAttribute("executePartnerObjLogic") == null) {
                            ...
                            for (int partid = 0; partid < partnerlist.size(); partid++) {
                                ...
                                log.info(accessDC.getDisplayRecord() + this.getClass() + accessDC.getDisplayRecord() + this.getClass() +
                                    ...
                                    for (int i = 0; i < user.getRoleList().size(); i++) {
                                        ...
                                        if (user.getRoleList().get(i).getRoleName().equals(Constants.ROLE_WCP_CARD_B2B_MGR)) {
                                            ...
                                            if (user.getRoleList().get(i).getIdString() != null) {
                                                ...
                                                int idlist = 0;
                                                log.info(accessDC.getDisplayRecord() + this.getClass() + " TEMP ------------->" +
                                                         user.getRoleList().get(i).getIdString().size());
                                                log.info(accessDC.getDisplayRecord() + this.getClass() + " Partner id " + partid + " " +
                                                         user.getRoleList().get(i).getIdString().get(idlist));

                                                if (session.getAttribute("partnerLang") == null) {
                                                    session.setAttribute("partnerLang",
                                                                         user.getRoleList().get(i).getIdString().get(0).toString().substring(0, 2));
                                                }
                                                ...
                                                int pIdStart = user.getRoleList().get(i).getIdString().get(partid).indexOf("PP");

                                                String pid = user.getRoleList().get(i).getIdString().get(partid).substring(pIdStart + 2, pIdStart + 10);
                                                ...
                                                if (session.getAttribute("partnerLang") != null) {
                                                    ...
                                                    log.info(accessDC.getDisplayRecord() + this.getClass() + " partner language null in session");
                                                ...
                                                do {
                                                    ...
                                                    if (partnerId != null && partnerId.equals(pid)) {
                                                        ...
                                                        if (user.getRoleList().get(i).getIdString().get(idlist).contains("AC") &&
                                                            partnerId.equals(user.getRoleList().get(i).getIdString().get(idlist).substring(pIdStart + 2,
                                                                                                                                           pIdStart + 10))) {


                                                            log.info(accessDC.getDisplayRecord() + this.getClass() + " Account B2B Manager");

                                                            acc = new AccountInfo();
                                                            cardgrouplist = new ArrayList<CardGroupInfo>();
                                                            int accIdStart = user.getRoleList().get(i).getIdString().get(idlist).indexOf("AC");

                                                            String accid =
                                                                user.getRoleList().get(i).getIdString().get(idlist).substring(accIdStart + 2, accIdStart + 12);
                                                            log.info(accessDC.getDisplayRecord() + this.getClass() + " account id " + accid);
                                                            acc.setAccountNumber(accid);
                                                            acc.setAccountOverview(true);
                                                            log.info(accessDC.getDisplayRecord() + this.getClass() + " Account overview should be visible");

                                                            AccountInfo accountCheck = new AccountInfo();
                                                            addflagaccount = false;
                                                            for (int listsize = 0; listsize < accountlist.size(); listsize++) {
                                                                log.info(accessDC.getDisplayRecord() + this.getClass() + " account id value in account list " +
                                                                         accountlist.get(listsize).getAccountNumber());
                                                                accountCheck = accountlist.get(listsize);
                                                            ...
                                                            if (!addflagaccount) {
                                                                ...
                                                                if (iter2 != null) {
                                                                    ...
                                                                    if ("CARDGROUP_SEQ =: cgid AND COUNTRY_CODE =: cc AND CARDGROUP_MAIN_TYPE=: cgmain AND CARDGROUP_SUB_TYPE=: cgsub AND PARTNER_ID=: pid".equalsIgnoreCase(vo2.getWhereClause())) {
                                                                        ...
                                                                        vo2.removeNamedWhereClauseParam("pid");
                                                                        vo2.setWhereClause("");
                                                                        vo2.executeQuery();
                                                                    ...
                                                                    vo2.defineNamedWhereClauseParam("cc", (String)session.getAttribute(Constants.userLang),
                                                                                                    null);
                                                                        ...
                                                                        while (vo2.hasNext()) {
                                                                            ...
                                                                            if (currRowcardgrp != null) {
                                                                                ...
                                                                                if (currRowcardgrp.getCardgroupSeq() != null) {
                                                                                    log.info(accessDC.getDisplayRecord() + this.getClass() +
                                                                                             " Cardgroup id is " + currRowcardgrp.getCardgroupSeq());
                                                                                ...
                                                                                for (int k = 0; k < cardgrouplist.size(); k++) {
                                                                                    ...
                                                                                    log.info(accessDC.getDisplayRecord() + this.getClass() +
                                                                                             " New cardgroup id value to compare" + cardgrp.getCardGroupID());
...

                                                                            {
                                                                                ...
                                                                                bindings =
                                                                                        (DCBindingContainer)BindingContext.getCurrent().getCurrentBindingsEntry().get("pageTemplateBinding");
                                                                                if (bindings == null ||
                                                                                    bindings.findIteratorBinding("PrtCardVO1Iterator") == null) {
                                                                                    bindings =
                                                                                ...
                                                                                if (iter3 != null) {
                                                                                    ...
                                                                                    if ("CARDGROUP_SEQ =: cgid AND COUNTRY_CODE =: cc AND CARDGROUP_MAIN_TYPE=: cgmain AND CARDGROUP_SUB_TYPE=: cgsub AND PARTNER_ID=: pid".equalsIgnoreCase(vo3.getWhereClause())) {
                                                                                        ...
                                                                                        vo3.removeNamedWhereClauseParam("pid");
                                                                                        vo3.setWhereClause("");
                                                                                        vo3.executeQuery();
                                                                                    }
                                                                                    ...
                                                                                    vo3.setWhereClause("CARDGROUP_SEQ =: cgid AND COUNTRY_CODE =: cc AND CARDGROUP_MAIN_TYPE=: cgmain AND CARDGROUP_SUB_TYPE=: cgsub AND PARTNER_ID=: pid");
                                                                                    ...
                                                                                    vo3.defineNamedWhereClauseParam("pid",
                                                                                    ...
                                                                                    vo3.executeQuery();
                                                                                    log.info(accessDC.getDisplayRecord() + this.getClass() +
                                                                                             " row count from card vo" + vo3.getEstimatedRowCount());
                                                                                    ...
                                                                                    if (vo3.getEstimatedRowCount() != 0) {
                                                                                        ...
                                                                                        //                                                                                                    //TODO : HITK - 17/9/2014 check if its set somewhere else
                                                            ...
                                                            int cgIdStart = user.getRoleList().get(i).getIdString().get(idlist).indexOf("CG");

                                                            String cardGroupID = user.getRoleList().get(i).getIdString().get(idlist).substring(cgIdStart + 2);
                                                            log.info(accessDC.getDisplayRecord() + this.getClass() + " CardGroupId is " + cardGroupID);

                                                            log.info(accessDC.getDisplayRecord() + this.getClass() + " Card Group B2B Manager");
                                                            ...
                                                            String cardgroupMainType =
                                                                user.getRoleList().get(i).getIdString().get(idlist).substring(cgIdStart + 2, cgIdStart + 5);
                                                            ...
                                                            //getcardGroupName(cardgroupMainType, cardgroupSubType, cardgroupSeq, user.getRoleList().get(i).getIdString().get(idlist).substring(pIdStart +2,pIdStart +10));
                                                            cardgrp.setCardGroupName(getcardGroupName(cardgroupMainType, cardgroupSubType, cardgroupSeq,
                                                                                                      user.getRoleList().get(i).getIdString().get(idlist).substring(pIdStart +
                                                                                                                                                                    2,
                                                                                                                                                                    pIdStart +
                                                                                                                                                                    10)));
                                                            if (cardgrp.getCardGroupName() != null) {
                                                            ...
                                                            log.info(accessDC.getDisplayRecord() + this.getClass() + " cardgroup seq " + cardgroupSeq);
                                                            log.info(accessDC.getDisplayRecord() + this.getClass() + " Cardgroup Maintype " +
                                                                     cardgroupMainType);
                                                            ...
                                                            if (bindings != null) {
                                                                ...
                                                                log.info(accessDC.getDisplayRecord() + this.getClass() + "Error : PrtCardVO1Iterator is null");
                                                                iter3 = null;
                                                            }
                                                            ...
                                                            if (iter3 != null) {
                                                                ...
                                                                //                                                                if ("CARDGROUP_SEQ =: cgid AND COUNTRY_CODE =: cc AND CARDGROUP_MAIN_TYPE=: cgmain AND CARDGROUP_SUB_TYPE=: cgsub AND ACCOUNT_ID=: acid".equalsIgnoreCase(vo3.getWhereClause())) {
                                                                //
                                                                //                                                                    vo3.removeNamedWhereClauseParam("cgid");
                                                                //                                                                    vo3.removeNamedWhereClauseParam("cc");
                                                                //                                                                    vo3.removeNamedWhereClauseParam("cgmain");
                                                                //                                                                    vo3.removeNamedWhereClauseParam("cgsub");
                                                                //                                                                    vo3.removeNamedWhereClauseParam("acid");
                                                                //                                                                    vo3.setWhereClause("");
                                                                //                                                                    vo3.executeQuery();
                                                                //                                                                }
                                            ...
                                            log.info(accessDC.getDisplayRecord() + this.getClass() + " CARD AMIN as user role =======>" +
                                            ...
                                            do {
                                                executeEmp = false;
                                                log.info(accessDC.getDisplayRecord() + this.getClass() + " User is B2B Employee");
                                                createCardGroupList = false;
                                                acc = new AccountInfo();
                                                cardgrp = new CardGroupInfo();
                                                ...
                                                int ccIdStart = user.getRoleList().get(i).getIdString().get(idlist).indexOf("CC");

                                                String cardId = user.getRoleList().get(i).getIdString().get(idlist).substring(ccIdStart + 2);
                                                ...
                                                if (partnerId != null && partnerId.equals(pid)) {
                                                    ...
                                                    if (iter3 != null) {
                                                        ...
                                                        if (vo3.getEstimatedRowCount() != 0) {
                                                            ...
                                                            while (vo3.hasNext()) {
                                                                ...
                                                                if (currRowcard != null) {
                                                                    ...
                                                                    if (currRowcard.getCardgroupMainType() != null &&
                                                                        currRowcard.getCardgroupSubType() != null && currRowcard.getCardgroupSeq() != null &&
                                                                        currRowcard.getAccountId() != null && currRowcard.getPartnerId() != null &&
                                                                        currRowcard.getAccountId() != null && currRowcard.getPartnerId() != null) {
                                                            ...
                                                            accountCheck = new AccountInfo();
                                                            cardGrpCheck = new CardGroupInfo();
                                                            ...
                                                            for (int listsize = 0; listsize < accountlist.size(); listsize++) {
                                                                ...
                                                                if (accountCheck.getAccountNumber().equalsIgnoreCase(acc.getAccountNumber())) {
                                                                    ...
                                                                    cardGrpListCheck = accountCheck.getCardGroup();

                                                                    for (int cardgrplistsize = 0; cardgrplistsize < cardGrpListCheck.size();
                                                                         cardgrplistsize++) {
                                                                        log.info(accessDC.getDisplayRecord() + this.getClass() +
                                                                        ...
                                                                        cardGrpCheck = cardGrpListCheck.get(cardgrplistsize);
                                                                        if (cardGrpCheck.getCardGroupMainType().equalsIgnoreCase(cardgrp.getCardGroupMainType()) &&
                                                                            ...
                                                                            for (int z = 0; z < cardgrouplist.size(); z++) {
                                                                                if (cardgrouplist.get(z).getCardGroupMainType().equals(cardGrpCheck.getCardGroupMainType()) &&
                                                                                    ...
                                                                                    cardgrouplist.set(z, cardGrpCheck);
                                                                                }
                                                                            }
                                                                        }
                                                                    }
                            ...
                            if (session != null && partnerListSession != null && partnerListSession.size() > 0) {
                                ...
                                log.info(accessDC.getDisplayRecord() + this.getClass() + " partner list added");
                                log.info(accessDC.getDisplayRecord() + this.getClass() + " session not null");
                ...
                log.info(accessDC.getDisplayRecord() + this.getClass() + " Exit From Binding phase");
    ...
    private void setUserInfoInSession() throws Exception {
        ...
        log.info(accessDC.getDisplayRecord() + this.getClass() + ".setUserInfoInSession : " + "MyPageListener.setUserInfoInSession: OPSS called for user: " +
        ...
        if (request.getServerName().contains("101") || request.getServerName().contains("localhost") || request.getServerName().contains("127.0")) {
            ...
            if (securityContext.getUserName().equalsIgnoreCase("weblogic")) {
                userList = userClient.searchUserWithUserId("B2BMgr2@test.com", Constants.ENGAGE_PORTAL);
...
//            userList = userClient.searchUserWithUserId(securityContext.getUserName(), Constants.ENGAGE_PORTAL);
        ...
        log.info(accessDC.getDisplayRecord() + this.getClass() + ".setUserInfoInSession : " + "securityContext.getUserName() = <" +
                 securityContext.getUserName() + ">");
        session.setAttribute(Constants.SESSION_USER_NAME, securityContext.getUserName());


        if (userList != null) {
            log.info(accessDC.getDisplayRecord() + this.getClass() + ".setUserInfoInSession : " + "userlist size " + userList.size());
        } else {
            log.info(accessDC.getDisplayRecord() + this.getClass() + "userlist size is null");
        }
        ...
        if (userList != null && !userList.isEmpty()) {
            ...
            if (getUser() != null) {
                ...
                log.info(accessDC.getDisplayRecord() + this.getClass() + ".setUserInfoInSession : " + "user.getUserID = <" + user.getUserID() + ">");
                ...
                if (user.getRolelist() != null && !user.getRolelist().isEmpty()) {
                    log.info(accessDC.getDisplayRecord() + this.getClass() + "Checking user get role list is proper or not===================>");
                    log.info(accessDC.getDisplayRecord() + this.getClass() + "RoleList size      -----------" + user.getRoleList().size());
                    log.info(accessDC.getDisplayRecord() + this.getClass() + "RoleName " + user.getRoleList().get(0).getRoleName());


                }
            } else {
                log.info(accessDC.getDisplayRecord() + this.getClass() + ".setUserInfoInSession : " +
        ...
        if (liuser != null && liuser.size() > 0) {
            ...
            if (us != null) {
                if (us.getEmailID() == null) {
                    ...
                    log.info(accessDC.getDisplayRecord() + this.getClass() + ".validateOPSSCall : " + "User EMAIL is NULL");
                    return false;
                }
                if (us.getRolelist() == null) {

                    session.setAttribute("SESSION_USER_ERROR", "ERROR_OPSS");
                    log.info(accessDC.getDisplayRecord() + this.getClass() + ".validateOPSSCall : " + "User ROLELIST is NULL");
                    return false;
                } else {
                    if (us.getRolelist().contains("WCP_Administrators") || us.getRolelist().contains(Constants.ROLE_WCP_CARD_B2C_SFR) ||
                        ...
                        log.info(accessDC.getDisplayRecord() + this.getClass() + ".validateOPSSCall : " + "Proper roles found");
                    } else {

                        session.setAttribute("SESSION_USER_ERROR", "ERROR_NOROLE");
                        log.info(accessDC.getDisplayRecord() + this.getClass() + ".validateOPSSCall : " + "Roles found are:" + us.getRolelist() +
                ...
                session.setAttribute("SESSION_USER_ERROR", "ERROR_OPSS");
                log.info(accessDC.getDisplayRecord() + this.getClass() + ".validateOPSSCall : " + "User OBJECT is NULL");
                return false;
            }
        } else {
            session.setAttribute("SESSION_USER_ERROR", "ERROR_OPSS");
            log.info(accessDC.getDisplayRecord() + this.getClass() + ".validateOPSSCall : " + "user LIST is NULL");
            return false;
        }
        return true;
    }
    ...
    private void executeAdmin(User user, int partIndex) {
        ...
        log.info(accessDC.getDisplayRecord() + this.getClass() + accessDC.getDisplayRecord() + this.getClass() + " Entered in execute Admin function");
        part = new PartnerInfo();
        accountlist = new ArrayList<AccountInfo>();
        cardgrouplist = new ArrayList<CardGroupInfo>();
        consistTwoInOneCardStatus = false;
        ...
        if (bindings != null && bindings.findIteratorBinding("PrtAccountVO1Iterator") != null) {
            ...
            log.info(accessDC.getDisplayRecord() + this.getClass() + accessDC.getDisplayRecord() + this.getClass() + " Partner id passed in Account VO is " +
                     partnerid);
            ...
            if (accountVO.getEstimatedRowCount() != 0) {
                while (accountVO.hasNext()) {
                    ...
                    if ("CARDGROUP_SEQ =: cgid AND COUNTRY_CODE =: cc AND CARDGROUP_MAIN_TYPE=: cgmain AND CARDGROUP_SUB_TYPE=: cgsub AND PARTNER_ID=: pid".equalsIgnoreCase(cardGroupVO.getWhereClause())) {
                        ...
                        cardGroupVO.removeNamedWhereClauseParam("pid");
                    ...
                    if (cardGroupVO.getEstimatedRowCount() != 0) {
                        while (cardGroupVO.hasNext()) {
                            ...
                            if ("CARDGROUP_SEQ =: cgid AND COUNTRY_CODE =: cc AND CARDGROUP_MAIN_TYPE=: cgmain AND CARDGROUP_SUB_TYPE=: cgsub AND PARTNER_ID=: pid".equalsIgnoreCase(cardVO.getWhereClause())) {

                                cardVO.removeNamedWhereClauseParam("cgid");
                                cardVO.removeNamedWhereClauseParam("cc");
                                cardVO.removeNamedWhereClauseParam("cgmain");
                                cardVO.removeNamedWhereClauseParam("cgsub");
                                cardVO.removeNamedWhereClauseParam("pid");
                                cardVO.setWhereClause("");
                                cardVO.executeQuery();
                            }
                            ...
                            cardVO.setWhereClause("CARDGROUP_SEQ =: cgid AND COUNTRY_CODE =: cc AND CARDGROUP_MAIN_TYPE=: cgmain AND CARDGROUP_SUB_TYPE=: cgsub AND PARTNER_ID=: pid");
                            ...
                            cardVO.defineNamedWhereClauseParam("pid", partnerid, null);
            ...
            partnerListSession.add(part);
            if (session != null && session.getAttribute("executePartnerObjLogic") == null) {
            ...
            log.info(accessDC.getDisplayRecord() + this.getClass() + " Error : PrtAccountVO1Iterator Bindings is null in my page listner for Admin role");
            iter1 = null;
        }
        log.info(accessDC.getDisplayRecord() + this.getClass() + " Exit from execute Admin function");
    }

    private void cardViewObject(ViewObject cardVO) {


        System.out.println("row count " + cardVO.getEstimatedRowCount());
        while (cardVO.hasNext()) {
            ...
            if (currRowcard != null) {
                ...
                if (currRowcard.getCardEmbossNum() != null) {
                    card.setExternalCardID(currRowcard.getCardEmbossNum().toString());
                    card.setDisplayCardNumber("XXXX" +
                                              currRowcard.getCardEmbossNum().toString().substring(currRowcard.getCardEmbossNum().toString().length() - 4,
                                                                                                  currRowcard.getCardEmbossNum().toString().length()));
                }
                ...
                if (currRowcard.getBlockAction() != null &&
                    (currRowcard.getBlockAction().equalsIgnoreCase("1") || currRowcard.getBlockAction().equalsIgnoreCase("0")) &&
                    currRowcard.getCardExpiry() != null && currRowcard.getCardExpiry().before(new Date())) {
                ...
                } else if (currRowcard.getBlockAction() != null && currRowcard.getBlockAction().equalsIgnoreCase("1")) {
                ...
                } else if (currRowcard.getBlockAction() != null && currRowcard.getBlockAction().equalsIgnoreCase("2")) {
                    perBlockCardList.add(card);
                    perBlockAndActiveCardList.add(card);
                    perBlockAndTempBlockCardList.add(card);
    ...
    public String getPartnerName(String partnerid) {
        ...
        if (bindings != null && bindings.findIteratorBinding("PrtPartnerVO1Iterator") != null) {
            ...
            if (partnerVO.getEstimatedRowCount() > 0) {
                ...
                if (currRowcard != null && currRowcard.getCompanyName() != null) {
    ...
    public String getcardGroupName(String cardgroupMainType, String cardgroupSubType, String cardgroupSeq, String partnerId) {
        ...
        if (bindings != null) {
            ...
            cardGroupVO.setWhereClause("CARDGROUP_SEQ =: cgid AND COUNTRY_CODE =: cc AND CARDGROUP_MAIN_TYPE=: cgmain AND CARDGROUP_SUB_TYPE=: cgsub AND PARTNER_ID=: pid");
            ...
            cardGroupVO.defineNamedWhereClauseParam("pid", partnerId, null);
            cardGroupVO.executeQuery();
            log.info(accessDC.getDisplayRecord() + this.getClass() + " RowCount for cardGroupVO  " + cardGroupVO.getEstimatedRowCount());

            if (cardGroupVO.getEstimatedRowCount() > 0) {
                PrtCardgroupVORowImpl currRowcard = (PrtCardgroupVORowImpl)cardGroupVO.next();
                if (currRowcard != null && currRowcard.getCardgroupDescription() != null) {

                    cardGroupName = currRowcard.getCardgroupDescription().toString();
                    log.info(accessDC.getDisplayRecord() + this.getClass() + " cardGroupName returned from database for cardGroupid " + cardgroupMainType +
                             " " + cardgroupSubType + " " + cardgroupSeq + " is " + cardGroupName);

                }
            }
        } else {
            log.info(accessDC.getDisplayRecord() + this.getClass() + " PrtCardGroupVO1Iterator Bindings is null in my page listner");
            iter1 = null;
        }
