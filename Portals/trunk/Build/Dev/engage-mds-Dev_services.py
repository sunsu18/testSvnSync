...
def deployAll():
 ...
 #Dev
 archive = getMDSArchiveConfig(fromLocation=r'C:\Program Files (x86)\Jenkins\jobs\Engage Trunk Build\workspace\EngagePortal\deploy\EngagePortal_application1.ear')
