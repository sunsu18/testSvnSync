...
public class ReportBundle {
    ...
    public String getContentsForReport(String pageBundle, String countryCode,
        ...
        try {
            ...
            String transactionsql =
                "{call PRT_GET_REPORT_RESOURCEBUNDLE(?,?)}";
            ...
            if (reportColumns != null && reportColumns.equals("")) {
                reportColumns =
                        reportColumns.substring(0, reportColumns.length() - 1);
