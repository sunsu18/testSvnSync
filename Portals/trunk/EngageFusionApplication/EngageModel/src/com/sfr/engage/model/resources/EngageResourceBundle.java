...
public class EngageResourceBundle extends ListResourceBundle{
    ...
    {"STATOIL_COMMERCIAL_CARD_LINK",""},{"STATOIL_BUSINESS_CARD_LINK",""} ,{"STATOIL_MASTER_CARD_LINK",""},{"STATOIL_EUROPE_CARD_LINK",""},
                                      ...
                                      {"REFERENCE_NUMBER",""} ,{"CARD_ASSOCIATED_VEHICLE",""},{"CARD_ASSOCIATED_DRIVER",""},{"COUNTRY_SWEDEN",""},{"COUNTRY_DENMARK",""},{"COUNTRY_NORWAY",""},{"NO_DATA",""} ,{"ACCESS_DENIED_ENG",""}, {"ACCESS_DENIED",""} , {"ENGAGE_FILTER_MESSAGE",""},{"EMAIL_CONFIRMATION",""},{"SURE_SEND_EMAIL",""},{"CONFIRM_EMAIL_ID",""},{"EMAIL",""},{"OK",""},{"MAIL_SUCCESSFUL",""},{"MAIL_NOT_FOUND",""},{"INVOICE_NOT_FOUND",""},
                                      {"CARD_TEXTLINE_2",""},{"VEHICLE_DISASSOCIATED",""},{"DRIVER_DISASSOCIATED",""},{"RESET",""},{"COUNTRY_HUNGARY",""},{"COUNTRY_ROMANIA",""},{"COUNTRY_BULGARIA",""},{"COUNTRY_GERMANY",""},{"COUNTRY_BOSNIA",""},{"COUNTRY_POLAND",""} };
