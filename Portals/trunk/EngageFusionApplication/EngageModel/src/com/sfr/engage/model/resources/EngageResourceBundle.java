...
public class EngageResourceBundle extends ListResourceBundle {
    ...
    { { "TOP_PRODUCTS_ENGAGE", "" }, { "SIGN_IN", "" }, { "CARD_PORTAL", "" },
      ...
      {"ENGAGE_TITLE",""},{ "PLEASE_SELECT_A_USER", "" },{"EXPIRED",""},
      ...
      {"CARD_STATUS_SELECTOR",""},{"ENGAGE_CARD_2_ID",""},{"RULE",""},
      {"SUBSCRIPTION_DATE",""},{"ALERT_DETAILS",""}};
      {"ENGAGE_USER_DETAILS",""},{"ENGAGE_ENTER_CARD",""}  ,{"CARD_STATUS_SELECTOR",""},{"ENGAGE_CARD_2_ID",""},{"PER_CARD_VIEW",""},{"FUELING_QUANTITY",""},{"AMOUNT",""}};
