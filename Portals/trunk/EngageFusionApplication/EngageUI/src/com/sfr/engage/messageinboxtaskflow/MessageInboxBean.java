    ...
    public List<SelectItem> getCategoryList() {
        if (categoryList == null) {
            ...
            if (resourceBundle.containsKey("ENGAGE_CATEGORY_NON_ADMIN")){
                ...
                selectItem1.setValue("Non Admin");
...
//        messageTypeList=new ArrayList<SelectItem>();
    ...
    public void searchResultsListener(ActionEvent actionEvent) {
        ...
        isSearchTableVisible=false;
            if(isMessageAdmin){
            if(getBindings().getCategory().getValue()!=null && getBindings().getMessageType().getValue() !=null && getBindings().getFromDate().getValue() != null && getBindings().getToDate().getValue() != null){
        ...
        if (customerTypeValue != null) {
            ...
            if(prtPCMFeedsVO.getWhereClause() != null && "INSTR(:customerType,CUSTOMER_TYPE)<>0  AND INFORMATION_TYPE =:infoType AND COUNTRY_CODE=:countryCode AND EFFECTIVE_DATE <=:fromDate AND END_DATE >=:toDate".equalsIgnoreCase(prtPCMFeedsVO.getWhereClause())){
            ...
            System.out.println(accessDC.getDisplayRecord() + this.getClass() + " " + "value of show flag ================>" + messageValue);
